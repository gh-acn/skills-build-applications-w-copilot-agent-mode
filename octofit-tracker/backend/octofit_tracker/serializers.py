...
class WorkoutSerializer(serializers.ModelSerializer):
    ...
    suggested_by_id = serializers.PrimaryKeyRelatedField(queryset=User.objects.all(), source='suggested_by', write_only=True)
    class Meta:
        model = Workout
        fields = ['id', 'name', 'description', 'suggested_by', 'suggested_by_id']
